...
public class CommandLineView {
	...
	public static GameRunner setup(Scanner scanner) {		
		...
		//String ruleSet = scanner.next(); for use in standard Rules for finalization of events.	
		String ruleSet = GameRunner.getRuleSets().get(scanner.nextInt());
		//String ruleSet = StandardRules.class.getCanonicalName();
